 ...
 *
 */
public class ThreadProxy implements AutoCloseable {
		...
		executorService = new ThreadPoolExecutor(1, 1,
            ...
            new ThreadFactory() {
				...
				public Thread newThread(final Runnable runnable) {
					final Thread thread = new Thread(THREAD_GROUP, runnable, UUID.randomUUID().toString());
	...
	public String toString() {
		return String.format("ID (%s/%s/%s)", this.executeCount, this.submitCount, this.exceptionCount);
	}
}